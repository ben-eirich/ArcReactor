...
namespace ArcReactor {
    public sealed class HashChain3 : IMatchFinder {
        int WindowBits;
        int WindowSize;
        int WindowMask;
        ...
        public HashChain3(byte[] data, int windowBits = 21, int maxProbes = 16) {
            Initialize(data, windowBits, maxProbes, windowBits);
        }

        public HashChain3(byte[] data, int windowBits, int maxProbes, int hashBits) {
